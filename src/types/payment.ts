...
export interface MockOrder { id: string; orderNumber: string; userId?: string; createdAt: string; status: 'confirmed_mock'; paymentStatus: 'paid'; buyer: BookingDraft['buyer']; passengers: BookingDraft['passengers']; outbound: BookingDraft['outbound']; inbound: BookingDraft['inbound']; ancillaries: string[]; coupon: BookingDraft['coupon']; pricing: PriceBreakdown; payment: OrderPaymentSnapshot; searchUrl: string; }
