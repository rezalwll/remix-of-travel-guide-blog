...
export interface BookingDraft { searchUrl: string; searchParams: Record<string, string>; outbound: FlightResult | null; inbound: FlightResult | null; buyer: BuyerContact; passengers: BookingPassenger[]; ancillaries: string[]; coupon: CouponApplication | null; termsAccepted: boolean; }
