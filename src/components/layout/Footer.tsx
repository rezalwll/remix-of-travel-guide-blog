...
const Footer = () => <footer className="mt-auto bg-[hsl(220_22%_17%)] text-white/80">
  <div className="container-page py-12 sm:py-16">
    ...
    <div className="mt-8 grid gap-3 border-t border-white/10 pt-6 text-xs text-white/45 sm:grid-cols-[1fr_auto] sm:items-center"><span>© {new Date().getFullYear()} کی‌آشی — پلتفرم مستقل رزرو و برنامه‌ریزی سفر</span><div className="flex items-center gap-2"><ShieldCheck className="size-4 text-secondary"/><span>پرداخت آزمایشی امن · اطلاعات مجوز پس از نهایی‌شدن قرارداد درج می‌شود</span></div></div>
  </div>
</footer>;
