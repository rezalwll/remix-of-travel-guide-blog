...
export default function SupportCenter() {
  ...
  return (
    <main id="main-content" className="min-h-[70vh] bg-muted/35">
      <TravelHero asset={serviceAsset("support", "تصویرسازی همراهی و پشتیبانی سفر")} size="compact" eyebrow="مرکز راهنمای کی‌آشی" title="برای ادامهٔ سفر تنها نیستی" description="پاسخ سریع دربارهٔ خرید، پرداخت، پیگیری و استرداد. برای اطلاعات سفارش، شناسهٔ پیگیری را آماده داشته باشید." />
