...
export default async function FlightRoutePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main id="main-content" className="min-h-[70vh] bg-muted/35">
      <TravelHero asset={destinationMedia} eyebrow="راهنمای مسیر · بدون ادعای قیمت زنده" title={route.title} description={route.summary} badges={[route.duration, `${route.originCode} ← ${route.destinationCode}`]} overlapBottom />
