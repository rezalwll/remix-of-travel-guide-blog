...
export default async function DestinationPage({ params }: { params: Promise<{ country: string; city: string }> }) {
  ...
  return (
    <main id="main-content" className="min-h-[70vh] bg-muted/35">
      ...
      <section className="pb-14 pt-10 sm:pb-20"><div className="container-page"><PromoBanner href="/support" asset={serviceAsset("support", "تصویر پشتیبانی برنامه‌ریزی سفر")} title="برای مرحلهٔ بعد سؤال داری؟" description="راهنمای خرید، پرداخت و پیگیری سفارش در مرکز راهنما جمع شده است." cta="مرکز راهنما" align="center" /></div></section>
    </main>
  );
}
